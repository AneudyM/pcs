    ...
    <nav class="navbar navbar-default navbar-static-top tm_navbar clearfix" role="navigation">
        <div class="container">
            <ul class="nav sf-menu clearfix">
                ...
                <li class="active"><a href="/capp/capp.php">Career Assessment Test</a></li>    
                <li><a href="#">Blog</a></li>
            </ul>
...
<div class="thumb-box">
        <div class="container">
            <strong>Career Assessment Test</strong>
            <p style="font-size: 20px; color: #666666">Nuestra prueba de evaluacion es perfecta para estudiantes, reccien graduados,
               jovenes profesionales, y adultos. Esta evaluacion te proveera de mucha informacion
               que te ayudara a tomar una mejor decision a la hora de buscar un trabajo o elegir una
               carrera.</p>
...
<div class="content indent">
    ...
    <div class="thumb-box11">
        <div class="container">
            <h2>Prueba de Evaluación</h2>
            <div class="row">
                <div class="thumb-box">
                    <div class="container">
                        <p style="font-size: 18px">Assessment test is currently under development.</p>
                    </div>
                </div>
                </br>
            </div>
...
<!--<div class="container">
        <div class="thumb-box8 indent">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10 col-lg-offset-3 col-md-offset-2 col-sm-offset-1">
                    <strong>special proposition</strong>
                    <p>Nulla non lorem in lectus volutpat facilisis in non nibh. Nulla a mi et sem laoreet ma lesuada nec qis odio. Nullam ut odio ultrices mollis arcu in convall is odioDuis turpis sem, malesuada condimentum eleifend et, aliquet vitae neque. Ut nec tristique nulla. Morbi vel est maximus, efficitur dolor vel, sod ales sapien. Fusce massa lorem, suscipit </p>
